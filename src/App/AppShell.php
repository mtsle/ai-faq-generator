	...
	public static function strings( string $lang ): array {
		$all = array(
			'pl' => array(
				...
				'setLabelTemp'  => __( 'Temperatura generatora FAQ', 'ai-faq-generator' ),
				'setTempHint'   => __( 'Dotyczy tworzenia pytań i odpowiedzi (zakładka „Narzędzie FAQ") — NIE wpływa na czat asystenta w zakładce „Generator". 0 = zwięźle i przewidywalnie · 1 = swobodniej.', 'ai-faq-generator' ),
			...
			'en' => array(
				...
				'setLabelModel' => __( 'Model', 'ai-faq-generator' ),
				'setLabelTemp'  => __( 'FAQ generator temperature', 'ai-faq-generator' ),
				'setTempHint'   => __( 'Applies to generating Q&A pairs (the "FAQ tool" tab) — does NOT affect the assistant chat in the "Generator" tab. 0 = concise and predictable · 1 = freer.', 'ai-faq-generator' ),
			...
			'de' => array(
				...
				'setLabelTemp'  => __( 'Temperatur des FAQ-Generators', 'ai-faq-generator' ),
				'setTempHint'   => __( 'Betrifft die Erstellung von Fragen und Antworten (Reiter „FAQ-Werkzeug") — wirkt sich NICHT auf den Chat-Assistenten im Reiter „Generator" aus. 0 = knapp und vorhersehbar · 1 = freier.', 'ai-faq-generator' ),
