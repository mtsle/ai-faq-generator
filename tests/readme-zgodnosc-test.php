...
// Odmiana zalezy od koncowki liczebnika (2306 -> asercji, 2362 -> asercje), wiec wzorzec
// przyjmuje obie formy. Inaczej straznik padalby na POPRAWNEJ polszczyznie.
rz_liczba( $readme, '/dok\x{0142}adnie (\d+) asercj[ei]\*\*/u', $suma_asercji, 'asercje wtyczki 2 (tabela CI)' );
