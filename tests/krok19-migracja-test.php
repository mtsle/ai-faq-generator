...
if ( file_exists( $uninstall ) ) {
	...
	check( 27 === $GLOBALS['__optc']->deletes, 'NOWE — C24: DOKŁADNIE 27 wywołań delete_option (16 + 9 opcji K20 + 2 opcje v0.24.0: aifaq_site_profile, aifaq_public_faq; jest: ' . $GLOBALS['__optc']->deletes . ')' );
} else {
