...
if ( file_exists( $uninstall ) ) {
	...
	check( array() === array_diff( array( 'aifaq_index_signature', 'aifaq_cache_flushed_for', 'aifaq_autoload_hardened' ), $deleted ), 'NOWE — C24: obie nowe opcje ORAZ znacznik utwardzenia autoloadu faktycznie SKASOWANE przez uninstall.php (nie substr_count na źródle)' );
	check( 28 === $GLOBALS['__optc']->deletes, 'NOWE — C24: DOKŁADNIE 28 wywołań delete_option (16 + 9 opcji K20 + 2 opcje v0.24.0: aifaq_site_profile, aifaq_public_faq + 1 opcja audytu: aifaq_autoload_hardened; jest: ' . $GLOBALS['__optc']->deletes . ')' );
} else {
